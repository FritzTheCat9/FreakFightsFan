...
namespace FreakFightsFan.Api.Features.Images.Commands
{
    public static class ImportFighterImages
    {
        ...
        public class Handler : IRequestHandler<ImportFighterImagesCommand, Unit>
        {
            ...
            public async Task<Unit> Handle(ImportFighterImagesCommand command, CancellationToken cancellationToken)
            {
        ...
        public static IEndpointRouteBuilder Endpoint(this IEndpointRouteBuilder app)
        {
            ...
            {
                var command = new ImportFighterImagesCommand();
